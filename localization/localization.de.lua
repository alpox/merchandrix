...
if GetLocale() == "deDE" then
	...
	Addon.L["Konfiguriere_SafeSell"] = "Konfiguriere hier ob sicheres Verkaufen aktiviert werden soll. Wenn aktiviert werden nie mehr als 12 items auf einmal verkauft.";
