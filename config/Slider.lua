...
local OptionsSlider = CreateFrame("Slider")
Addon.OptionsSlider = OptionsSlider

OptionsSlider.mt = { __index = OptionsSlider };

--[[ Constructor ]]--

function OptionsSlider:New(name, parent, low, high, step)
	local f = setmetatable(CreateFrame('Slider', parent:GetName() .. name, parent, 'OptionsSliderTemplate'), self.mt);
